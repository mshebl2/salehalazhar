    ...
    <>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={project.images[0] || `/placeholder.svg?height=600&width=1200&query=${project.title} project banner`}
            alt={project.title}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center text-white max-w-4xl mx-auto">
            <div className="bg-[#C4D600] text-[#0D2240] px-4 py-2 rounded-full text-sm font-medium inline-block mb-4">
              {categoryNames[project.category as keyof typeof categoryNames]}
            </div>
              ...
              <div className="relative mb-6">
                <img
                  src={
                    ...
                    `/placeholder.svg?height=500&width=800&query=${project.title || "/placeholder.svg"} main view`
                  }
                  alt={project.title}
                ...
                {project.images.map((image, index) => (
                  ...
                  >
                    <img
                      src={
                        image ||
                        `/placeholder.svg?height=150&width=200&query=${project.title || "/placeholder.svg"} view ${index + 1}`
                      }
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-[#0D2240]">
                        طريق الأمير عبدالمحسن بن عبدالعزيز، نبلاء، المدينة المنورة 42385
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
